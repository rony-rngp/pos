                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body card-dashboard">
                                    <form class="form" id="quickForms" action="{{ route('update.customer',$customer->id) }}" method="post">
                                        @csrf
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="mobile" class="form-control" id="mobile" value="{{ $customer->mobile }}" placeholder="Enter Mobile">
